        ...
        <div class="form-container">
          <el-form :model="user" :rules="rules" ref="loginref" class="login-form">
            ...
            <el-form-item prop="username">
              <el-input class="custom-input" prefix-icon="user" size="large" placeholder="Account" v-model="user.username" clearable></el-input>
            </el-form-item>
            ...
            <el-form-item prop="confirmpass">
              <el-input class="custom-input" prefix-icon="lock" size="large" show-password placeholder="Password" v-model="user.confirmpass" clearable></el-input>
            </el-form-item>
...
<!--            </div>-->
            <el-form-item>
              <el-button type="primary" style="width: 100%;background-color:#5f9592" @click="register">Sign Up</el-button>
            </el-form-item>
            <div style="display:flex">
              <div style="flex: 1;margin-bottom: 30px">Already have an account?Go <span style="color:lightseagreen; cursor: pointer; text-decoration: underline;" @click="$router.push('/login')">Log in</span></div>
            </div>
          </el-form>
        </div>
      </div>
