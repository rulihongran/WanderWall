    ...
    <div class="header-background" @click="triggerFileInput" :style="backgroundStyle">
      ...
      <div v-if="!backgroundImage" class="ProfileBanner-promptContainer-fgV ProfileBanner-transparentNavPromptContainer-xAj">
        <div class="ProfileBanner-prompt-yBZ">
          ...
          <button class="ProfileBanner-promptHeading-tkX" @click="triggerFileInput">Add banner image</button>
          <p class="ProfileBanner-assetSuggestion-ADZ">Best size 3200 x 410px</p>
        </div>
      </div>
    </div>
    ...
    <div  class="center2">
      <div class="left" style="margin: 20px;">
          <div class="avatar-container">
            <div class="avatar" >
            <img :src="avatar" style="border-radius:100px" alt="Avatar">
             </div>
          </div>
          <div style="  display: flex;justify-content: center;top:0;">
            <h1 class="username">{{ username }}</h1>
          </div>
          <div style="margin-top:  40px;margin: 20px;"><el-button type="primary" round style="width: 100%; background-color:#5f9592;font-size: 20px" @click="$router.push({ name: 'EditView' })"><i class="el-icon-edit">Modify info</i></el-button>
          </div>
          <div>
            <div>
             <h2>{{ signature }}</h2>
  ...
  export default {
    ...
    data() {
      return {
        ...
        showPrompt: true,
        src:null,
        avatar:"https://database-6bf6.obs.cn-east-3.myhuaweicloud.com/RedTideGuard/UserAvatar/default.png",
      ...
      tabs: [
        // { name: '故事', link: 'work' },
        { name: 'Friends', link: 'friend' },
        { name: 'More', link: 'addfriend' },
      ],
    ...
    methods: {
      load() {
        ...
        const user_bucket = res.bucket;
        const user_object = res.object;
        if (user_object){
          this.$http({
        ...
        params: {bucket: user_bucket, object: user_object},
          ...
          this.avatar = "https://database-6bf6.obs.cn-east-3.myhuaweicloud.com/RedTideGuard/UserAvatar/default.png";
        }
