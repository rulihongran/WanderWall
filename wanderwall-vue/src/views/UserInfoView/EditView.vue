  ...
  <div style="height: 1000px; width: 100%;display: flex;background-color: #f9f9f9;">
    <div class="nav">
        <div class="button-style">
            <el-button type="primary" round @click="$router.push({ name: 'UserView' })">
                <i class="el-icon-edit">Return </i></el-button></div>
    </div>
    <div class="back1">
        <div class="back2">
        ...
        <el-card class="box-card" :body-style="{ padding: '0px' }">
          ...
          <div  class="clearfix" style="padding:10px;margin:5px">
