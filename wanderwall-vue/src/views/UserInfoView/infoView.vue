<template>
  <div >
    <el-card style="height: 100%;">
      <el-descriptions class="margin-top" title="Profile" :column="2" border>
        <template #extra v-if=1>
        <el-button type="primary" size="small" @click="isEditing = !isEditing;saveProfile()">{{ isEditing ? 'Save' : 'Modify' }}</el-button>
      </template>
      ...
      <el-descriptions-item>
        ...
        <div v-else>
            ...
            <el-button type="primary" @click="triggerFileInput" style="margin-left:10px;margin-bottom:20px">Upload<i class="el-icon-upload el-icon--right"></i></el-button>
        </div>
        ...
        <el-descriptions-item>
          <template #label>
            <el-icon><UserFilled /></el-icon> Nickname
          </template>
      ...
      <el-descriptions-item >
    <template #label>
      <el-icon><odometer /></el-icon> Birthday
    </template>
    ...
    <el-row v-else style="width: 300px;">
      ...
      <el-descriptions-item>
        <template #label>
          <el-icon><map-location/></el-icon>Area
        </template>
      ...
      <el-descriptions-item>
        <template #label>
          <el-icon><male/></el-icon><el-icon><female/></el-icon>Gender
        </template>
        <span v-if="!isEditing">{{ sex }}</span>
        <el-select v-else v-model="sex" placeholder="Choose one">
      ...
      <el-descriptions-item>
        <template #label>
          <el-icon><Basketball /></el-icon>Hobby
        </template>
      ...
      <el-descriptions-item>
        <template #label>
          <el-icon><magic-stick /></el-icon>Signature
        </template>
