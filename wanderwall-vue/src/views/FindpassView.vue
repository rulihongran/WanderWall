        ...
        <div class="form-container">
          <el-form :model="user" :rules="rules" ref="loginref" class="login-form">
            ...
            <el-form-item prop="password">
              <el-input class="custom-input" prefix-icon="lock" size="large" show-password placeholder="请输入新密码" v-model="user.password" clearable></el-input>
            </el-form-item>
            ...
            <div style="display:flex">
              <div style="flex: 1;margin-bottom: 30px">放弃修改?去<span style="color:lightseagreen; cursor: pointer; text-decoration: underline;" @click="$router.push('/login')">登录</span></div>
            </div>
          </el-form>
        </div>
      </div>
