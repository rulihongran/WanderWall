          ...
          <div class="header-container" >
            ...
            <div v-else class="nav-v2-avatar">
              <a data-nav-v2-avatar="true" title="Open profile" href="/userinfo">
                <img class="nav-v2-avatar__image" alt="avatar" :src="avatar" />
              </a>
...
export default {
  ...
  created() {
    ...
    this.$http.get("/user/"+this.user.username).then(res => {
        ...
        params: {bucket: user_bucket, object: user_object},
          ...
          const url = res;
          this.avatar = url?url:"https://database-6bf6.obs.cn-east-3.myhuaweicloud.com/RedTideGuard/UserAvatar/default.png";
          console.log(url);
      });
        }else{
